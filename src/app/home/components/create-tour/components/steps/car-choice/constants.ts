...
export const CAR_OPTIONS: readonly CarOption[] = [
  {
    id: 'model-3',
    image: '/images/create-tour/cars/model-3.png',
    label: 'Tesla Model 3',
    price: 320,
  },
  {
    id: 'model-y',
    image: '/images/create-tour/cars/model-y.png',
    label: 'Tesla Model Y',
    price: 360,
  },
  {
    id: 'cybertruck',
    image: '/images/create-tour/cars/cybertruck.png',
    label: 'Tesla Cybertruck',
    price: 450,
  },
  {
    id: 'id-buzz',
    image: '/images/create-tour/cars/id-buzz.png',
